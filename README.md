...
Как показал Google NGrams самым частотынм продолжением фразы "due to the" будет "due to the fact". Полагаю, это можно объяснить универсальностью этой конструкции, которая позволят объяснять наибольший спектр различных ситуаций, а отличии от остальных вариантов.

Доказательства: [due to the](https://github.com/unreallguy/hw6/blob/master/Due%20to.JPG)

В английском языке "park" чаще встречается в значении парка, что полагаю объяснимо тем, что парк как существительное описывает более частовстречающийся феномен, чем парк в значении парковать.

Доказательства: [park](https://github.com/unreallguy/hw6/blob/master/Part%20os%20speech.JPG)

Сравнение употреблений слов "underground" и "subway", позволяет поставить под вопрос гипотезу о том, что "undergroud" это английское наименование, а "subway" американское. Потому что "underground" впринципе чаше употребляется, чем "subway". Хотя доля правды в этом есть, ведь каждое слово в своем языке всё же лидирует. 

Доказательства: [subway&underground](https://github.com/unreallguy/hw6/blob/master/AmericanEnglish.JPG)
